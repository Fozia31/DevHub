  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-20 bg-white border-b border-slate-200 px-8 flex items-center justify-between z-[100] shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="flex items-center gap-2 px-3 py-2 rounded-lg font-bold text-xs text-red-400 hover:bg-red-50 hover:text-red-600 transition-all">
          <LogOut size={16} />
          <span className="hidden lg:inline">Sign Out</span>
        </button>
        <div className="w-10 h-10 rounded-full border-2 border-slate-100 overflow-hidden bg-slate-50">
           <img src="https://ui-avatars.com/api/?name=Student&background=6366f1&color=fff" alt="User" />
        </div>
      </div>
    </nav>
  );
